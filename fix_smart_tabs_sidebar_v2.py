...
# Match from Role Outline Card down to PREMIUM INTERNSHIP PORTAL
bound_pattern = re.compile(r'(\s*<!-- Role Outline Card -->.*?)(?=<!-- ═══════════════════════════════════════════════════════\n     PREMIUM INTERNSHIP PORTAL)', re.DOTALL)
...
'''
    ...
    print("Failed to find bound marker.")
