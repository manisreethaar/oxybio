        ...
        <footer className="w-full bg-white border-t border-slate-200 py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 pt-8 border-t border-slate-200 text-center text-sm text-slate-500">
                    <p className="text-slate-500 text-xs text-center max-w-4xl mx-auto mb-4 border border-slate-200 p-4 rounded-lg bg-slate-50">
                        Oxygen Bioinnovations Private Limited is a pre-revenue R&D-stage startup. All products are currently in Phase 0 lab validation. No commercial product is available for sale. Functional claims described on this website are based on published nutritional literature and are labelled accordingly (PUBLISHED / PLAUSIBLE / PLANNED). These claims represent our research direction and have not been independently evaluated or approved by FSSAI. This website does not constitute medical advice.
                    </p>
