...
const TrustBar = () => {
    const items = [
        "Phase 0 Lab Validation Underway",
        "FSSAI Licensing In Progress",
        "100% Indian Ingredients",
        "Zero Artificial Additives",
        "Hot-Water Fruiting Body Extracts Only",
        "Heritage Grain Fermentation Platform",
        "Species-Specific Extraction Protocol Per SKU",
        "DPIIT Startup India Recognition Applied",
        "Incubated at TBI-DETI@ACE"
    ];
